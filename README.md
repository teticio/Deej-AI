...
**UPDATE**: After nearly 5 years, I have finally got around to re-training the model deployed at https://deej-ai.online. The fact that people have been consistently continuing to use it is testament to how well it works, but it was about time I included tracks recorded since 2018! I have added a `train` directory to this repo where you can find a `README` with detailed instructions on how to obtain datasets and train your own model from scratch.
